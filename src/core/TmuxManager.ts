...
export class TmuxManager {
    ...
    async createOrAttachSession(ssh: Client, sessionName: string): Promise<void> {
    ...
    async sendInput(ssh: Client, sessionName: string, input: string): Promise<void> {
    ...
    async sendCommand(ssh: Client, sessionName: string, command: string): Promise<void> {
    ...
    async sendSignal(ssh: Client, sessionName: string, signal: "SIGINT" | "SIGTERM"): Promise<void> {
    ...
    async capturePane(ssh: Client, sessionName: string, lines: number): Promise<string> {
