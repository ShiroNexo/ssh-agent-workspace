...
export async function handleHostSecurity(args: unknown, hostSecurityManager: HostSecurityManager) {
    ...
    switch (action) {
        ...
        case "set": {
            if (!host) {
                return {
                    content: [{ type: "text" as const, text: 'Error: "host" parameter required for set' }],
                    isError: true,
                };
            }
        ...
        case "remove": {
            if (!host) {
                return {
                    content: [{ type: "text" as const, text: 'Error: "host" parameter required for remove' }],
                    isError: true,
                };
            }
