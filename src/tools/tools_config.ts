...
export async function handleToolsConfig(args: unknown, toolConfigManager: ToolConfigManager) {
    ...
    switch (action) {
        ...
        case "enable": {
            if (!tool) {
                return {
                    content: [{ type: "text" as const, text: 'Error: "tool" parameter required for enable' }],
                    isError: true,
                };
            }
        ...
        case "disable": {
            if (!tool) {
                return {
                    content: [{ type: "text" as const, text: 'Error: "tool" parameter required for disable' }],
                    isError: true,
                };
            }
            if (tool === "tools_config") {
                return {
                    content: [{ type: "text" as const, text: "Error: Cannot disable tools_config itself" }],
                    isError: true,
                };
            }
        ...
        case "reset": {
            ...
            return {
                content: [{ type: "text" as const, text: "All tools reset to enabled (default)" }],
            };
        }
    }
}
